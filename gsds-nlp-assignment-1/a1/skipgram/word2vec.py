...
def negSamplingLossAndGradient(
    ...
    Implement a binary classification loss for skip gram that utilizes negative sampling for word2vec model.
    ...
    Arguments and Return Specifications:
        K-- number of negative samples to take.
        the rest are the same as naiveSoftmaxLossAndGradient with an addition of K
    """
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for word in outsideWords:
        loss_tmp, cvec_tmp, ovec_tmp= word2vecLossAndGradient(centerWordVectors[word2Ind[currentCenterWord]]
